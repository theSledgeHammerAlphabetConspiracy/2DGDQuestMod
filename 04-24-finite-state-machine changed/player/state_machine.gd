...
func _ready():
	for state_node in $States.get_children():
		...
		if state_node.cancelable == true:
			cancel_state_array.append(state_node.get_name().to_lower())
...
func _change_state(state_name):
	...
	elif state_name in cancel_state_array:
	#elif state_name in ["stagger", "jump", "attack"]:#removed for the array
		states_stack.push_front(states_map[state_name])
		#print(["stagger", "jump", "attack"])
		#print(cancel_state_array)
	...
	######HERE
	if state_name == "jump":#this needs to go
